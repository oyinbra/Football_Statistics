...
from csv_operations import export_match_statistics_to_csv
...
if __name__ == "__main__":
    while True:
        ...
        export_match_statistics_to_csv(match_ids, file_title, csv_file, fetch_match_details, fetch_match_statistics, prepare_statistics_row)
